...
Esta classe representa todo um nível e os seus consituintes (jogador, elementos UI, plataformas, lasers, espinhos...)
...
O módulo do RTC é responsável por obter informação acerca da hora atual --- \textit{get\_date()}, bem como programar alarmes. --- \textit{rtc\_set\_alarm()}. --- rtc.c \newline

...
Permite transparência e aplicar uma cor sobre o que é renderizado. O \textit{path} absoluto para os \textit{assets} pode ser alterado como um \textit{command line argument}.
